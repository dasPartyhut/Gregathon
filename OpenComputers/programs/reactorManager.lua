...
local DEBUG = 1 --Unter Bearbeitung
...
local WAITTIMEDEBUG = 1 --takt-zyklus 1s
local NDEBUG = 60*24*7  --Takt Zyklen in einer Woche
local N1DEBUG = 60*24   --Takt Zyklen an einem Tag
local DEBUGCYCLES = 5 
...
while runLoop() do
  ...
  runningAVG = 100 * runningCycles / nCycles
  runningAVGDay = 100 * runningCyclesDay / dayDiv
  runningAVGWeek = 100 * runningCyclesWeek / weekDiv
